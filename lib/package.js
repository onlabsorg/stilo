...
class Package {
    ...
    get config () {
        ...
        const commands = Object.assign({}, config.commands);
        ...
        for (let plugin of plugins) {
            ...
            if (isObject(plugin.commands)) Object.assign(commands, plugin.commands);
        }
        return {routes, protocols, commands};
    }
    ...
    get store () {
        ...
        const Router = this.require('./lib/router');
        return new Router(routes, protocols);
    }
